      ...
      <section className="welcome-hero small-hero">
        <div className="hero-content">
          <div className="hero-badge">
            <Users size={14} /> <span>Athlete Directory</span>
          </div>
          <h1>All Athletes</h1>
          <p>
            Browse and manage your athlete roster. Use quick actions to view
            profiles.
          </p>
        </div>
      </section>
      ...
      <section className="recent-activity-section glass-premium">
        <div className="activity-header">
          ...
          <div className="activity-filters">
            <input
              placeholder="Search by name, reg no or state..."
              value={searchTerm}
              onChange={(e) => {
        ...
        <div className="activity-table-wrapper">
                ...
                <tr key={a.id}>
                  <td>
                    <div className="athlete-cell">
                      <img
                        src={a.photo || "https://via.placeholder.com/40"}
                        alt=""
                      />
                      <div>
          ...
          {filtered.length === 0 && (
            <div className="empty-state">No athletes found.</div>
          )}
          <div
