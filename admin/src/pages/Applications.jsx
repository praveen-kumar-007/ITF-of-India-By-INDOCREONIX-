...
const Applications = () => {
  ...
  const handleDelete = (id) => {
    setActionModal({
      ...
      type: "warning",
      title: "Move to Trash?",
      message: "Move this application to recycle bin?",
      confirmText: "Move",
    ...
    <main className="dashboard-container animate-fade-in">
      <section className="welcome-hero small-hero">
        <div className="hero-content">
          ...
          <p>
            Review new registrations and take action — approve, reject, or move
            to recycle bin.
          </p>
        </div>
      </section>
          ...
          <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
            ...
            <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
              <button
                ...
                onClick={() => {
                  selectAllVisible();
                  showToast("All visible selected", "info");
                }}
              >
                Select All
              </button>
              <button className="btn-report" onClick={clearSelection}>
                Clear
              </button>
              <button
                className="btn-report"
                ...
                <tr key={r.id}>
                  ...
                  <td>
                    <div className="athlete-cell">
                      <img
                        src={r.photo || "https://via.placeholder.com/40"}
                        alt=""
                      />
                      <div>
                  ...
                  <td>
                    <div className="action-row">
                      <button
                        ...
                        onClick={() => navigate(`/athletes/${r.id}`)}
                        title="View"
                      >
                        <Eye size={16} />
                      </button>
                          ...
                          <button
                            ...
                            onClick={() =>
                              setActionModal({
                                ...
                                message: `Approve ${r.fullName}?`,
                                confirmText: "Approve",
                                onConfirm: () =>
                                  executeStatusUpdate(r.id, "approved"),
                              })
                            }
                            title="Approve"
                          >
                          ...
                          <button
                            ...
                            onClick={() =>
                              setActionModal({
                                ...
                                message: `Reject ${r.fullName}? Provide reason.`,
                                showInput: true,
                                inputPlaceholder: "Reason...",
                                confirmText: "Reject",
                                onConfirm: (reason) =>
                                  executeStatusUpdate(r.id, "rejected", reason),
                              })
                            }
                            title="Reject"
                          >
