      ...
      <div className="auth-card glass-premium">
        <div className="auth-header">
          <div className="auth-logo">
            <img
              src="https://res.cloudinary.com/dgfpfxkpk/image/upload/q_auto/f_auto/v1777829890/logo_hdbywh.png"
              alt="ITF India"
            />
          </div>
          <h1>
            {mode === "request" ? "Password Security" : "Secure Verification"}
          </h1>
          <p>
            {mode === "request"
              ? "Enter your email to receive a secure setup code"
        ...
        {mode === "verify" && (
          <form className="auth-form" onSubmit={handleVerifyAndSet}>
            ...
            <div className="input-group">
              <label>
                <Lock size={16} /> Create New Password
              </label>
              <input
                type="password"
                name="newPassword"
            ...
            <button type="submit" className="auth-btn" disabled={loading}>
              {loading ? "Processing..." : "Complete Security Setup"}{" "}
              <KeyRound size={18} />
            </button>
            <div className="auth-footer">
              <button
